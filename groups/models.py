...
class Post(models.Model):
    ...
    group = models.ForeignKey('Group', on_delete=models.CASCADE)  # Assuming you have a Group model
    ...
    def get_absolute_url(self):
        return reverse('posts:single', kwargs={'pk': self.pk})  # Adjust URL pattern name as needed
